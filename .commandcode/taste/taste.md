...
- Prefers showing the actual/original data the model saw rather than a reconstructed approximation — even when exact data isn't always available, the goal is to maximize accuracy. Confidence: 0.7
